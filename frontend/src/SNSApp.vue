        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="cookingManagements"
                        to="/cooks/cookingManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="tableManagements"
                        to="/tables/tableManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'CookingManagement', 
                description: '', 
                key: 'cookingManagements', 
                route: '/cooks/cookingManagements',
                ImageUrl: '',
            },
            { 
